 ...
 * @author PC
 */
public class DisplayPlayerEquipe extends Form{
    ...
    public DisplayPlayerEquipe(Equipe p) {
        current = this;
        Container list = new Container(BoxLayout.y());
        list.setScrollableY(true);
        ArrayList<Joueur> lg = SE.getJoueurEquipe(p);
...
//
//                new InfoJoueur("mahdi", "bhima", "pos", sc, log, prix, eq).show();
//
//            });
